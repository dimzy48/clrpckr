...
r_Scale = Scale(frame, from_=0, to=255, length=210,
                fg="red", orient=HORIZONTAL, command=slide)
r_Scale.grid(row=0, column=1)

g_label = Label(frame, text="G", fg="green", font=('arial', 10, 'bold'))
g_label.grid(row=1, column=0)

g_Scale = Scale(frame, from_=0, to=255, length=210,
                fg="green", orient=HORIZONTAL, command=slide)
g_Scale.grid(row=1, column=1)

b_label = Label(frame, text="B", fg='blue', font=('arial', 10, 'bold'))
b_label.grid(row=2, column=0)

b_Scale = Scale(frame, from_=0, to=255, length=210,
                fg='blue', orient=HORIZONTAL, command=slide)
...
copyButton1 = Button(my_frame, text='Copy', font=(
    'arial', 10, 'bold'), command=hex_copy)
...
copyButton2 = Button(my_frame, text='Copy', font=(
    'arial', 10, 'bold'), command=rgb_copy)
copyButton2.grid(row=3, columnspan=2, pady=7)

l_ontime = Button(my_frame, text='Go Realtime!', font=(
    'arial', 10, 'bold'), command=realtime)
